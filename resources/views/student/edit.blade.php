...
@section('content')
    <div class="row">
        <div class="col-md-12 text-center"><i class="fa fa-graduation-cap fa-5x"></i>
            <h1 class="display-2">Editar Estudante #{{$student->id}}</h1>
        </div>
        <div class="col-md-6 offset-md-3">
            <form method="POST" action="{{ route('editStudent', $student->id) }}">
                @csrf
                <fieldset>
                    <!-- Text input-->
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input id="name" name="name" type="text" placeholder="Nome do estudante" value="{{ old('name', $student->name) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input id="cpf" name="cpf" type="text" placeholder="000.000.000-00" value="{{ old('cpf', $student->cpf) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input id="birthday" name="birthday" type="date" placeholder="Data" value="{{ old('birthday', $student->birthday->format('Y-m-d')) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input id="email" name="email" type="email" placeholder="Digite seu email" value="{{ old('email', $student->email) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input id="phone" name="phone" type="text" placeholder="(00) 00000-0000" value="{{ old('phone', $student->phone) }}"
                        ...
                        <div class="col-md-12">
                            <select id="course_id" name="course_id" class="form-control input-md @error('course_id') is-invalid @enderror">
                                ...
                                @foreach ($courses as $course)
                                    @if (old('course_id', $student->course_id) == $course->id)
                        ...
                        <div class="col-md-12">
                            <select id="period" name="period" class="form-control input-md @error('period') is-invalid @enderror">
                                ...
                                @for ($period = 1; $period <= 12; $period++)
                                    @if (old('period', $student->period) == $period)
